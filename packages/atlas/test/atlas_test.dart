...
main() {
  group('Atlas', () {
    ...
    testWidgets(
        'should call provider build method with correct arguments when map clusters are provided',
        (WidgetTester tester) async {
    ...
    testWidgets(
        'should call provider build method with correct arguments when map trackPlayback is provided',
        (WidgetTester tester) async {
